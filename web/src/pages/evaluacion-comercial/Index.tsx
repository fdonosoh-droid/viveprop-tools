...
import { StepIndicator } from '@/components/evaluacion-comercial/StepIndicator';
import { PropertyTypeSelector } from '@/components/evaluacion-comercial/PropertyTypeSelector';
import { ConfigStep } from '@/components/evaluacion-comercial/ConfigStep';
import { SubjectStep } from '@/components/evaluacion-comercial/SubjectStep';
import { ComparablesCasaStep } from '@/components/evaluacion-comercial/ComparablesCasaStep';
import { ComparablesDeptStep } from '@/components/evaluacion-comercial/ComparablesDeptStep';
import { ResultsStep } from '@/components/evaluacion-comercial/ResultsStep';
import { RentalStep } from '@/components/evaluacion-comercial/RentalStep';
import { ReportStep } from '@/components/evaluacion-comercial/ReportStep';
import {
  DEFAULT_PARAMS,
...
import { runCasaValuation, runDeptoValuation } from '@/lib/evaluacion/engines';
import type {
  PropertyType,
  MarketParams,
  Subject,
...
const Index = () => {
  ...
  return (
    <div className="eval-comercial-scope min-h-screen bg-background">
