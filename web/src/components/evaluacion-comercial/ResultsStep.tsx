...
import { formatUF, formatCLP } from '@/lib/evaluacion/engines';
import type { ValuationResult, MarketParams, CasaValuationResult, DeptoValuationResult } from '@/lib/evaluacion/types';
