...
import { formatUF, formatPercent, processComparableCasa } from '@/lib/evaluacion/engines';
import { MATERIAL_LABELS, STATE_LABELS } from '@/lib/evaluacion/types';
import type { ComparableCasa, MarketParams, MaterialType, ConservationState } from '@/lib/evaluacion/types';
