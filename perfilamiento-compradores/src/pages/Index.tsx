      ...
      <main className="flex-1">
        ...
        <section className="container pb-12">
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <Card className="p-8 flex flex-col items-center text-center hover:shadow-lg transition-shadow cursor-pointer border-2 hover:border-accent/40" onClick={() => navigate('/evaluacion')}>
            ...
            <Card className="p-8 flex flex-col items-center text-center hover:shadow-lg transition-shadow cursor-pointer border-2 hover:border-accent/40" onClick={() => navigate('/propiedad')}>
