...
import { formatUF, processComparableDepto } from '@/lib/engines';
import { FACTOR_ESTADO_OPTIONS, FACTOR_ORIENT_OPTIONS, FACTOR_ANTIPUB_OPTIONS } from '@/lib/types';
import type { ComparableDepto, MarketParams } from '@/lib/types';
